...
flags.DEFINE_string('data_dir', 'F:\hsi_data\Salinas scene\SAData.mat', 'Directory of data file.')
flags.DEFINE_string('label_dir', 'F:\hsi_data\Salinas scene\SAGt.mat', 'Directory of label file.')
flags.DEFINE_string('train_dir', 'F:\hsi_result\original\SA\exp4', 'The train result save file.')
...
def run_training():
    ...
    data = sio.loadmat('F:\hsi_result\original\PU\data\data8.mat')
