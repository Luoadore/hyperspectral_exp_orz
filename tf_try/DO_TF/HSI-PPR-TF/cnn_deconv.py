...
def ppr_block(inp, kernels, stride, bands_size, is_training):
...
def inference(dataset, conv1_kernel, conv1_stride, fc_uints, num_class, bands_size, is_training):
    ...
    with tf.name_scope('ppr'):
        conv1 = ppr_block(dataset, conv1_kernel, conv1_stride, bands_size, is_training)
